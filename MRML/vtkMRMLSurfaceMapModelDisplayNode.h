/*=auto=========================================================================
  ...
  Program:   3D Slicer
  Module:    $RCSfile: vtkMRMLSurfaceMapModelDisplayNode.h,v $
  Date:      $Date: 2006/03/19 17:12:28 $
  Version:   $Revision: 1.6 $

=========================================================================auto=*/

#ifndef __vtkMRMLSurfaceMapModelDisplayNode_h
#define __vtkMRMLSurfaceMapModelDisplayNode_h
...
///
/// vtkMRMLSurfaceMapModelDisplayNode nodes stores display property of a 3D surface model
/// including reference to ColorNode, texture, opacity, etc.
class VTK_MRML_EXPORT vtkMRMLSurfaceMapModelDisplayNode : public vtkMRMLDisplayNode
{
public:
  static vtkMRMLSurfaceMapModelDisplayNode *New();
  vtkTypeMacro(vtkMRMLSurfaceMapModelDisplayNode,vtkMRMLDisplayNode);
...
protected:
  vtkMRMLSurfaceMapModelDisplayNode();
  ~vtkMRMLSurfaceMapModelDisplayNode();
  vtkMRMLSurfaceMapModelDisplayNode(const vtkMRMLSurfaceMapModelDisplayNode&);
  void operator=(const vtkMRMLSurfaceMapModelDisplayNode&);
