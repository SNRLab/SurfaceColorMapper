/*=auto=========================================================================
  ...
  Program:   3D Slicer
  Module:    $RCSfile: vtkMRMLSurfaceMapModelNode.h,v $
  Date:      $Date: 2006/03/19 17:12:28 $
  Version:   $Revision: 1.6 $

=========================================================================auto=*/

#ifndef __vtkMRMLSurfaceMapModelNode_h
#define __vtkMRMLSurfaceMapModelNode_h
...
/// When a model display node (vtkMRMLSurfaceMapModelDisplayNode) is observed by the
...
class VTK_MRML_EXPORT vtkMRMLSurfaceMapModelNode : public vtkMRMLDisplayableNode
{
public:
  static vtkMRMLSurfaceMapModelNode *New();
  vtkTypeMacro(vtkMRMLSurfaceMapModelNode,vtkMRMLDisplayableNode);
...
protected:
  vtkMRMLSurfaceMapModelNode();
  ~vtkMRMLSurfaceMapModelNode();
  vtkMRMLSurfaceMapModelNode(const vtkMRMLSurfaceMapModelNode&);
  void operator=(const vtkMRMLSurfaceMapModelNode&);
  ...
  virtual void SetPolyDataToDisplayNode(vtkMRMLSurfaceMapModelDisplayNode* modelDisplayNode);
