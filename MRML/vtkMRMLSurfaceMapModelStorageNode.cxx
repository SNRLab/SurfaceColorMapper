/*=auto=========================================================================
  ...
  Program:   3D Slicer
  Module:    $RCSfile: vtkMRMLSurfaceMapModelStorageNode.cxx,v $
...
//----------------------------------------------------------------------------
vtkMRMLNodeNewMacro(vtkMRMLSurfaceMapModelStorageNode);

//----------------------------------------------------------------------------
vtkMRMLSurfaceMapModelStorageNode::vtkMRMLSurfaceMapModelStorageNode()
{
}
...
//----------------------------------------------------------------------------
void vtkMRMLSurfaceMapModelStorageNode::PrintSelf(ostream& os, vtkIndent indent)
{
  vtkMRMLStorageNode::PrintSelf(os,indent);
}

//----------------------------------------------------------------------------
bool vtkMRMLSurfaceMapModelStorageNode::CanReadInReferenceNode(vtkMRMLNode *refNode)
{
  return refNode->IsA("vtkMRMLSurfaceMapModelNode");
}

//----------------------------------------------------------------------------
int vtkMRMLSurfaceMapModelStorageNode::ReadDataInternal(vtkMRMLNode *refNode)
{
  vtkMRMLSurfaceMapModelNode *modelNode = dynamic_cast <vtkMRMLSurfaceMapModelNode *> (refNode);
...
//----------------------------------------------------------------------------
int vtkMRMLSurfaceMapModelStorageNode::WriteDataInternal(vtkMRMLNode *refNode)
{
  vtkMRMLSurfaceMapModelNode *modelNode = vtkMRMLSurfaceMapModelNode::SafeDownCast(refNode);

  std::string fullName = this->GetFullNameFromFileName();
  if (fullName == std::string(""))
    {
    vtkErrorMacro("vtkMRMLSurfaceMapModelNode: File name not specified");
    return 0;
    }
...
//----------------------------------------------------------------------------
void vtkMRMLSurfaceMapModelStorageNode::InitializeSupportedReadFileTypes()
{
...
//----------------------------------------------------------------------------
void vtkMRMLSurfaceMapModelStorageNode::InitializeSupportedWriteFileTypes()
{
...
//----------------------------------------------------------------------------
const char* vtkMRMLSurfaceMapModelStorageNode::GetDefaultWriteFileExtension()
{
  return "vtk";
}
