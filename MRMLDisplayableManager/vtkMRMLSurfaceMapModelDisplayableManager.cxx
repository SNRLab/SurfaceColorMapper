/*=========================================================================
  ...
  Program:   3D Slicer
  Module:    $HeadURL: http://svn.slicer.org/Slicer4/trunk/Base/GUI/vtkMRMLSurfaceMapModelDisplayableManager.cxx $
...
#include "vtkMRMLSurfaceMapModelDisplayableManager.h"
...
//---------------------------------------------------------------------------
vtkStandardNewMacro (vtkMRMLSurfaceMapModelDisplayableManager );
vtkCxxRevisionMacro ( vtkMRMLSurfaceMapModelDisplayableManager, "$Revision: 13525 $");

//---------------------------------------------------------------------------
class vtkMRMLSurfaceMapModelDisplayableManager::vtkInternal
{
public:
  vtkInternal();
  ~vtkInternal();
...
//---------------------------------------------------------------------------
vtkMRMLSurfaceMapModelDisplayableManager::vtkInternal::vtkInternal()
{
...
//---------------------------------------------------------------------------
void vtkMRMLSurfaceMapModelDisplayableManager::vtkInternal::CreateClipSlices()
{
...
//---------------------------------------------------------------------------
void vtkMRMLSurfaceMapModelDisplayableManager::vtkInternal::ResetPick()
{
...
//---------------------------------------------------------------------------
// vtkMRMLSurfaceMapModelDisplayableManager methods

//---------------------------------------------------------------------------
vtkMRMLSurfaceMapModelDisplayableManager::vtkMRMLSurfaceMapModelDisplayableManager()
{
...
//---------------------------------------------------------------------------
void vtkMRMLSurfaceMapModelDisplayableManager::PrintSelf ( ostream& os, vtkIndent indent )
{
  this->vtkObject::PrintSelf ( os, indent );

  os << indent << "vtkMRMLSurfaceMapModelDisplayableManager: " << this->GetClassName() << "\n";
...
//---------------------------------------------------------------------------
void vtkMRMLSurfaceMapModelDisplayableManager::AdditionnalInitializeStep()
{
  ...
  if (interactor)
    ...
    if (interactorStyle)
      {
      interactorStyle->SetModelDisplayableManager((vtkMRMLModelDisplayableManager*) this);
      }
    }
...
//---------------------------------------------------------------------------
vtkMRMLClipModelsNode* vtkMRMLSurfaceMapModelDisplayableManager::GetClipModelsNode()
{
...
//---------------------------------------------------------------------------
void vtkMRMLSurfaceMapModelDisplayableManager::SetClipModelsNode(vtkMRMLClipModelsNode *snode)
{
  vtkSetAndObserveMRMLNodeMacro(this->Internal->ClipModelsNode, snode);
}

//---------------------------------------------------------------------------
int vtkMRMLSurfaceMapModelDisplayableManager::UpdateClipSlicesFromMRML()
{
...
//---------------------------------------------------------------------------
void vtkMRMLSurfaceMapModelDisplayableManager::SetClipPlaneFromMatrix(vtkMatrix4x4 *sliceMatrix,
                                                            int planeDirection,
                                                            vtkPlane *plane)
{
  double normal[3];
...
//---------------------------------------------------------------------------
void vtkMRMLSurfaceMapModelDisplayableManager::ProcessMRMLNodesEvents(vtkObject *caller,
                                                           unsigned long event,
                                                           void *callData)
{
  ...
  if (vtkMRMLDisplayableNode::SafeDownCast(caller))
    ...
    switch (event)
      ...
      case vtkMRMLSurfaceMapModelNode::PolyDataModifiedEvent:
...
//---------------------------------------------------------------------------
void vtkMRMLSurfaceMapModelDisplayableManager::OnMRMLSceneStartClose()
{
...
//---------------------------------------------------------------------------
void vtkMRMLSurfaceMapModelDisplayableManager::OnMRMLSceneEndClose()
{
  // Clean
...
//---------------------------------------------------------------------------
void vtkMRMLSurfaceMapModelDisplayableManager::UpdateFromMRMLScene()
{
...
//---------------------------------------------------------------------------
void vtkMRMLSurfaceMapModelDisplayableManager::OnMRMLSceneNodeAdded(vtkMRMLNode* node)
{
...
//---------------------------------------------------------------------------
void vtkMRMLSurfaceMapModelDisplayableManager::OnMRMLSceneNodeRemoved(vtkMRMLNode* node)
{
  if (!node->IsA("vtkMRMLDisplayableNode") &&
      !node->IsA("vtkMRMLDisplayNode") &&
      !node->IsA("vtkMRMLModelHierarchyNode") &&
...
//---------------------------------------------------------------------------
bool vtkMRMLSurfaceMapModelDisplayableManager::IsModelDisplayable(vtkMRMLDisplayableNode* node)const
{
  vtkMRMLSurfaceMapModelNode* modelNode = vtkMRMLSurfaceMapModelNode::SafeDownCast(node);
  if (!modelNode)
    {
    return false;
    }
...
//---------------------------------------------------------------------------
bool vtkMRMLSurfaceMapModelDisplayableManager::IsModelDisplayable(vtkMRMLDisplayNode* node)const
{
  vtkMRMLSurfaceMapModelDisplayNode* modelDisplayNode = vtkMRMLSurfaceMapModelDisplayNode::SafeDownCast(node);
  if (!modelDisplayNode)
    {
    return false;
    }
...
//---------------------------------------------------------------------------
bool vtkMRMLSurfaceMapModelDisplayableManager::OnMRMLDisplayableModelNodeModifiedEvent(
...
//---------------------------------------------------------------------------
void vtkMRMLSurfaceMapModelDisplayableManager::UpdateFromMRML()
{
  if ( this->GetInteractor() &&
       this->GetInteractor()->GetRenderWindow() &&
       this->GetInteractor()->GetRenderWindow()->CheckInRenderStatus())
...
//---------------------------------------------------------------------------
void vtkMRMLSurfaceMapModelDisplayableManager::UpdateModelsFromMRML()
{
...
//---------------------------------------------------------------------------
void vtkMRMLSurfaceMapModelDisplayableManager::UpdateModifiedModel(vtkMRMLDisplayableNode *model)
{
...
//---------------------------------------------------------------------------
void vtkMRMLSurfaceMapModelDisplayableManager
::UpdateModelPolyData(vtkMRMLDisplayableNode *displayableNode)
{
  ...
  vtkMRMLSurfaceMapModelNode* modelNode = vtkMRMLSurfaceMapModelNode::SafeDownCast(displayableNode);
  vtkMRMLDisplayNode *hdnode = this->GetHierarchyDisplayNode(displayableNode);
  vtkMRMLSurfaceMapModelNode *hierarchyModelDisplayNode =
    vtkMRMLSurfaceMapModelNode::SafeDownCast(hdnode);
  ...
  for (unsigned int i=0; i<displayNodes.size(); i++)
    ...
    vtkMRMLSurfaceMapModelDisplayNode *modelDisplayNode =
      vtkMRMLSurfaceMapModelDisplayNode::SafeDownCast(displayNode);
...
//---------------------------------------------------------------------------
void vtkMRMLSurfaceMapModelDisplayableManager::UpdateModel(vtkMRMLDisplayableNode *model)
{
  ...
  // observe polydata
  observations = broker->GetObservations(model, vtkMRMLSurfaceMapModelNode::PolyDataModifiedEvent,
                                         this, this->GetMRMLNodesCallbackCommand());
  if (observations.size() == 0)
    {
    broker->AddObservation(model, vtkMRMLSurfaceMapModelNode::PolyDataModifiedEvent,
                           this, this->GetMRMLNodesCallbackCommand());
...
//---------------------------------------------------------------------------
void vtkMRMLSurfaceMapModelDisplayableManager::CheckModelHierarchies()
{
...
//---------------------------------------------------------------------------
void vtkMRMLSurfaceMapModelDisplayableManager::AddHierarchyObservers()
{
  if (this->GetMRMLScene() == 0)
    {
    return;
...
//---------------------------------------------------------------------------
void vtkMRMLSurfaceMapModelDisplayableManager::UpdateModelHierarchies()
{
...
//---------------------------------------------------------------------------
void vtkMRMLSurfaceMapModelDisplayableManager::UpdateModelHierarchyVisibility(vtkMRMLModelHierarchyNode* mhnode, int visibility )
{
  if (!mhnode)
    {
    return;
...
//---------------------------------------------------------------------------
void vtkMRMLSurfaceMapModelDisplayableManager::UpdateModelHierarchyDisplay(vtkMRMLDisplayableNode *model)
{
  if (model)
    {
...
//---------------------------------------------------------------------------
vtkMRMLDisplayNode*  vtkMRMLSurfaceMapModelDisplayableManager::GetHierarchyDisplayNode(vtkMRMLDisplayableNode *model)
{
...
//---------------------------------------------------------------------------
void vtkMRMLSurfaceMapModelDisplayableManager::RemoveModelProps()
{
  std::map<std::string, vtkProp3D *>::iterator iter;
  ...
  for(iter=this->Internal->DisplayedActors.begin(); iter != this->Internal->DisplayedActors.end(); iter++)
    ...
    if (modelDisplayNode == 0)
      ...
      if (clipIter == this->Internal->DisplayedClipState.end())
        {
        vtkErrorMacro ("vtkMRMLSurfaceMapModelDisplayableManager::RemoveModelProps() Unknown clip state\n");
        }
      else
        {
...
//---------------------------------------------------------------------------
void vtkMRMLSurfaceMapModelDisplayableManager::RemoveDisplayable(vtkMRMLDisplayableNode* model)
{
  if (!model)
    {
    return;
...
//---------------------------------------------------------------------------
void vtkMRMLSurfaceMapModelDisplayableManager::RemoveDispalyedID(std::string &id)
{
...
//---------------------------------------------------------------------------
int vtkMRMLSurfaceMapModelDisplayableManager::GetDisplayedModelsVisibility(vtkMRMLDisplayNode *model)
{
  int visibility = 0;
...
//---------------------------------------------------------------------------
void vtkMRMLSurfaceMapModelDisplayableManager::RemoveMRMLObservers()
{
  this->RemoveModelObservers(1);
  this->RemoveHierarchyObservers(1);
...
//---------------------------------------------------------------------------
void vtkMRMLSurfaceMapModelDisplayableManager::RemoveModelObservers(int clearCache)
{
...
//---------------------------------------------------------------------------
void vtkMRMLSurfaceMapModelDisplayableManager::RemoveDisplayableNodeObservers(vtkMRMLDisplayableNode *model)
{
  vtkEventBroker *broker = vtkEventBroker::GetInstance();
  std::vector< vtkObservation *> observations;
  if (model != 0)
    ...
    observations = broker->GetObservations(
      model, vtkMRMLSurfaceMapModelNode::PolyDataModifiedEvent, this, this->GetMRMLNodesCallbackCommand() );
...
//---------------------------------------------------------------------------
void vtkMRMLSurfaceMapModelDisplayableManager::RemoveHierarchyObservers(int clearCache)
{
  vtkEventBroker *broker = vtkEventBroker::GetInstance();
  std::vector< vtkObservation *> observations;
  std::map<std::string, int>::iterator iter;
...
//---------------------------------------------------------------------------
void vtkMRMLSurfaceMapModelDisplayableManager::SetModelDisplayProperty(vtkMRMLDisplayableNode *model)
{
        ...
        if (modelDisplayNode->GetScalarVisibility())
          ...
          actor->GetMapper()->SelectColorArray(
            this->GetActiveScalarName(modelDisplayNode,
                                      vtkMRMLSurfaceMapModelNode::SafeDownCast(model)));
...
//---------------------------------------------------------------------------
const char* vtkMRMLSurfaceMapModelDisplayableManager
::GetActiveScalarName(vtkMRMLDisplayNode* displayNode,
                      vtkMRMLSurfaceMapModelNode* modelNode)
{
  const char* activeScalarName = 0;
  if (displayNode)
    {
    vtkMRMLSurfaceMapModelDisplayNode *modelDisplayNode = vtkMRMLSurfaceMapModelDisplayNode::SafeDownCast(displayNode);
...
//---------------------------------------------------------------------------
bool vtkMRMLSurfaceMapModelDisplayableManager
...
vtkProp3D * vtkMRMLSurfaceMapModelDisplayableManager::GetActorByID(const char *id)
{
  if ( !id )
    {
    return (0);
...
const char * vtkMRMLSurfaceMapModelDisplayableManager::GetIDByActor(vtkProp3D *actor)
{
  if ( !actor )
    {
    return (0);
...
//---------------------------------------------------------------------------
vtkWorldPointPicker* vtkMRMLSurfaceMapModelDisplayableManager::GetWorldPointPicker()
{
...
//---------------------------------------------------------------------------
vtkPropPicker* vtkMRMLSurfaceMapModelDisplayableManager::GetPropPicker()
{
...
//---------------------------------------------------------------------------
vtkCellPicker* vtkMRMLSurfaceMapModelDisplayableManager::GetCellPicker()
{
...
//---------------------------------------------------------------------------
vtkPointPicker* vtkMRMLSurfaceMapModelDisplayableManager::GetPointPicker()
{
...
//---------------------------------------------------------------------------
int vtkMRMLSurfaceMapModelDisplayableManager::Pick(int x, int y)
{
    ...
    if (polyData != 0)
      ...
      for (modelIter = this->Internal->DisplayedNodes.begin();
        ...
        if (modelIter->second != 0)
          {
          if (vtkMRMLSurfaceMapModelNode::SafeDownCast(modelIter->second) &&
              vtkMRMLSurfaceMapModelNode::SafeDownCast(modelIter->second)->GetPolyData() == polyData)
            {
...
//---------------------------------------------------------------------------
const char * vtkMRMLSurfaceMapModelDisplayableManager::GetPickedNodeID()
{
...
//---------------------------------------------------------------------------
double* vtkMRMLSurfaceMapModelDisplayableManager::GetPickedRAS()
{
...
//---------------------------------------------------------------------------
void vtkMRMLSurfaceMapModelDisplayableManager::SetPickedRAS(double* newPickedRAS)
{
  int i;
...
//---------------------------------------------------------------------------
vtkIdType vtkMRMLSurfaceMapModelDisplayableManager::GetPickedCellID()
{
...
//---------------------------------------------------------------------------
void vtkMRMLSurfaceMapModelDisplayableManager::SetPickedCellID(vtkIdType newCellID)
{
...
//---------------------------------------------------------------------------
vtkIdType vtkMRMLSurfaceMapModelDisplayableManager::GetPickedPointID()
{
...
//---------------------------------------------------------------------------
void vtkMRMLSurfaceMapModelDisplayableManager::SetPickedPointID(vtkIdType newPointID)
{
...
//---------------------------------------------------------------------------
vtkMRMLModelHierarchyLogic* vtkMRMLSurfaceMapModelDisplayableManager::GetModelHierarchyLogic()
{
...
//---------------------------------------------------------------------------
vtkClipPolyData* vtkMRMLSurfaceMapModelDisplayableManager::CreateTransformedClipper(
