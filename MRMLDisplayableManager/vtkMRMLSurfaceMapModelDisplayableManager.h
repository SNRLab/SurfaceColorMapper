/*=========================================================================
  ...
  Module:    $HeadURL: http://svn.slicer.org/Slicer4/trunk/Base/GUI/vtkMRMLSurfaceMapModelDisplayableManager.h $
  Date:      $Date: 2010-05-12 08:34:19 -0400 (Wed, 12 May 2010) $
  Version:   $Revision: 13332 $

==========================================================================*/

#ifndef __vtkMRMLSurfaceMapModelDisplayableManager_h
#define __vtkMRMLSurfaceMapModelDisplayableManager_h
...
class VTK_MRML_DISPLAYABLEMANAGER_EXPORT vtkMRMLSurfaceMapModelDisplayableManager :
    public vtkMRMLAbstractThreeDViewDisplayableManager
{
public:
  static vtkMRMLSurfaceMapModelDisplayableManager* New();
  vtkTypeRevisionMacro(vtkMRMLSurfaceMapModelDisplayableManager,vtkMRMLAbstractThreeDViewDisplayableManager);
...
protected:
  ...
  vtkMRMLSurfaceMapModelDisplayableManager();
  virtual ~vtkMRMLSurfaceMapModelDisplayableManager();
  ...
  const char* GetActiveScalarName(vtkMRMLDisplayNode* displayNode,
                                  vtkMRMLSurfaceMapModelNode* model = 0);
...
private:
  ...
  vtkMRMLSurfaceMapModelDisplayableManager(const vtkMRMLSurfaceMapModelDisplayableManager&); // Not implemented
  void operator=(const vtkMRMLSurfaceMapModelDisplayableManager&);                 // Not Implemented
